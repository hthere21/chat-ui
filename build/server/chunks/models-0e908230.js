import { H as HF_TOKEN, l as OPENAI_API_KEY, m as MODELS, n as OLD_MODELS, T as TEXT_EMBEDDING_MODELS, o as HF_API_ROOT } from './private-f03b1afd.js';
...
async function endpointOai(input) {
  ...
  let OpenAI;
  try {
    OpenAI = (await import('./index-2225d401.js').then(function (n) { return n.a; })).OpenAI;
  } catch (e) {
...
export { defaultEmbeddingModel as a, buildPrompt as b, chunk as c, defaultModel as d, embeddingModels as e, models as m, oldModels as o, smallModel as s, validateModel as v };
//# sourceMappingURL=models-0e908230.js.map
